	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<h3>Learn More with </br>Our Corporate Presentation</h3>	
				<a href="<?php echo get_page_link( get_page_by_title( Download )->ID ); ?>"class="button-main button-with-shadow button-align-left-desktop" id="banner-contact-button">Download Now</a>
