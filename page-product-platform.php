 ...
 * Template Name: product_platforms
...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<div class="platform-wrapper">
				...
				<div class="platform-manager">
					<div class="platform-manager-text">
						...
						<p>VALO’s Smart City Manager provides cities with direct secure access to their information, and the ability to control
				...
				<div class="platform-icon-box-wrapper">
					...
					<img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/smart-city-led-lighting-01.svg'; ?>"/></a>
						<h3>Basic Street Lights Control</h3>
                        <p>On/Off and dimming by groups or zones</p>
                    </div>
					<div class="platform-icon-box "><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/connection-diagnostics-01.svg'; ?>"/></a>
						<h3>Connection Diagnostics</h3>
                        <p>Total connected by groups or by zone, and energy consumed</p></div>
					<div class="platform-icon-box platform-icon-box-grey"><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/equipment-diagnostics-01.svg'; ?>"/></a>
					...
					<div class="platform-icon-box "><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/analytics-01.svg'; ?>"/></a>
			...
			<div class="platform-icon-box-wrapper ">
					<div class="platform-icon-box-sensors platform-icon-box-blue"><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/smart-city-sensor-01.svg'; ?>"/></a>
					...
					<div class="platform-icon-box-sensors platform-icon-box-grey"><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/event-sensors-01.svg'; ?>"/></a>
					...
					<div class="platform-icon-box-sensors"><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/gas-sensors-01.svg'; ?>"/></a>
			...
			<div class="platform-icon-box-sensors-final"><img alt="A green car" class="platform-icon-box-img " src="<?php echo get_template_directory_uri() . '/assets/product-platform/parking-sensors-01.svg'; ?>"/></a>
