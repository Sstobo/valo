      ...
      <section class="content-wrapper">
       ...
       <section class="service-wrapper">
        ...
        <section class="wifi">
          ...
          <p>Free public WiFi access can be delivered with VALO’s WiFi unit which creates wireless hotspots where people can access the internet at no cost. Public WiFi has many benefits for cities and users, such as convenient access to services, support for tourism, education, and communication channels for disaster relief.</p>
        </section><!-- close wifi-->
