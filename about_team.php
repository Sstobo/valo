			...
			<section class="content-wrapper">
				...
				<div class="about-team-management-team-container">
					...
					<div class="about-team-single-team-member-container terrance-dittrich">
						...
						<img alt="Terrence Dittrich" src="<?php echo get_template_directory_uri() . '/assets/managment-photos/Terrence Dittrich.png'?>" id="Terrence Dittrich"
						/>
					...
					<div class="about-team-single-team-member-container julio-ferreira">
						...
						<img alt="Julio Ferreira" src="<?php echo get_template_directory_uri() . '/assets/managment-photos/Julio Ferreira.png'?>" id="Julio Ferreira"
						/>
